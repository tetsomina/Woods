...
darkmode_run_day="/home/tetsomina/.local/bin/theme_switcher.sh -l"
darkmode_run_night="/home/tetsomina/.local/bin/theme_switcher.sh -d"
...
setpaper_construct(){
    ...
    if [ "$oguri_enable" == "true" ];then 
        ...
        /home/tetsomina/.local/bin/sun_animate.sh -a "$image"
    fi
